...
sections.register("slideshow-section", {
  onLoad(e) {
    ...
    $(".slideshow__video", slideshow).each(function() {
      var $el = $(this);
      SlideshowVideo.init($el);
      SlideshowVideo.loadVideo($el.attr("id"));
    });

    slideshows[slideshow] = new Slideshow(slideshow);
    // Get the element
  ...
  onBlockSelect(e) {
    ...
    let $slide = $(".slideshow__slide--" + blockId + ":not(.slick-cloned)");
